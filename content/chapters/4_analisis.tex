...
% TODO: Poner que las funcionalidades de la app se basan en los endpoints disponibles de la API, no al revés
...
% TODO: Copiar el nuevo con (tracks) en el nombre y añadir otro con (artists)
\begin{figure}[H]
    \centering
...
% TODO: Poner que no me deja coger el historial de escucha de más de 50 tracks
% TODO: y que en vez de eso he decidido usar como proxy el endpoint de user's saved tracks
