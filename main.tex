...
\input content/chapters/4_analisis
\cleardoublepage

\chapter{Diseño} \label{ch:diseño}
\input content/chapters/5_diseno
\cleardoublepage

\chapter{Implementación} \label{ch:implementacion}
\input content/chapters/6_implementacion
\cleardoublepage

\chapter{Pruebas} \label{ch:pruebas}
\input content/chapters/7_pruebas
\cleardoublepage

\chapter{Despliegue} \label{ch:despliegue}
\input content/chapters/8_despliegue
\cleardoublepage

\chapter{Conclusiones} \label{ch:conclusiones}
\input content/chapters/9_conclusiones
\cleardoublepage
